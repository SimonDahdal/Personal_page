...
- Read the HTML template from "jinja_templates/reasercher_personal_page.template.html", substitute the placeholders ($conference, $journal, $patents) using string.Template, and write the final HTML output to "./index.html".
